...
{
  "$end", "error", "$undefined", "NUMBER", "SINE", "LEFT", "RIGHT",
  "NEWLINE", "ID", "$accept", "line", YY_NULLPTR
};
#endif
...
{
       2,    18,     7,     8,    19,     5,    12,     3,     4,     6,
       9,    10,    11,    13,    14,    15,    16,    17,    20,     0,
       0,    21,    22
};
